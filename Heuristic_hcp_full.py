...
#Diffusion scans
dti_98dir_ap = create_key('sub-{subject}/{session}/dwi/sub-{subject}_{session}_dir-98dir_dir-AP_dwi')
dti_98dir_pa = create_key('sub-{subject}/{session}/dwi/sub-{subject}_{session}_dir-98dir_dir-PA_dwi')
dti_99dir_ap = create_key('sub-{subject}/{session}/dwi/sub-{subject}_{session}_dir-99dir_dir-AP_dwi')
dti_99dir_pa = create_key('sub-{subject}/{session}/dwi/sub-{subject}_{session}_dir-99dir_dir-PA_dwi')
...
dti_98dir_ap_sbref = create_key('sub-{subject}/{session}/dwi/sub-{subject}_{session}_dir-98dir_dir-AP_sbref')
dti_98dir_pa_sbref = create_key('sub-{subject}/{session}/dwi/sub-{subject}_{session}_dir-98dir_dir-PA_sbref')
dti_99dir_ap_sbref = create_key('sub-{subject}/{session}/dwi/sub-{subject}_{session}_dir-99dir_dir-AP_sbref')
dti_99dir_pa_sbref = create_key('sub-{subject}/{session}/dwi/sub-{subject}_{session}_dir-99dir_dir-PA_sbref')
